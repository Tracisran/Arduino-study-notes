...
void loop() {  
  ...
  */
  ...
  static unsigned long varR_LED_Color = 0;
  if(myGizwits.hasBeenSet(EVENT_LED_COLOR))
  {
    myGizwits.read(EVENT_LED_COLOR,&varR_LED_Color);//Address for storing data 
  }
...
{
  case 0: setPiexlColorAll(varR_LED_R,varR_LED_G,varR_LED_B);break;
  case 1: setPiexlColorAll(255,255,0);break;
  case 2: setPiexlColorAll(255,0,90);break;
  case 3: setPiexlColorAll(256,90,90);break; 
}

setPiexlColorAll(varR_LED_R,varR_LED_G,varR_LED_B);
